...
//WriteResult wr = customerColl.update(searchDoc, foundDoc, false, false, WriteConcern.ACKNOWLEDGED);
customerColl.update(searchDoc, foundDoc, false, false, WriteConcern.majorityWriteConcern(10000,false,true));
